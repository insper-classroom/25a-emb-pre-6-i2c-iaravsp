...
void i2c_task(void *p) {
    ...
    i2c_write_blocking(i2c_default, BMP280, &reg_address, 1, true); // true to keep master control of bus
    i2c_read_blocking(i2c_default, BMP280, buffer, 1, false);
